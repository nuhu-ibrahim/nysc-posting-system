...
<head>
  ...
  <title>NYSC System | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>NYSC </b>System</a>
  </div>
  <!-- /.login-logo -->
    ...
    <?php echo $this->upload->display_errors('<div class="alert alert-error">', '</div>'); ?>
            <?php echo form_open_multipart(); ?>
                    ...
                    <div class="form-group has-feedback">
                        <?php echo form_input('username', $username, array("class"=>"form-control", "placeholder"=>"Username")); ?>
...
<!-- iCheck -->
<script src="<?php echo base_url('assets/ui/'); ?>js/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
